            ...
            <div className="px-4 md:px-16 lg:px-24 xl:px-32">
                {
                    loading ? (
                                    ...
                                    projects.map((project) => (
                                        ...
                                        >
                                            ...
                                            <div onClick={(e) => e.stopPropagation()}>
                                                <TrashIcon
                                                    className="absolute top-3 right-3 scale-0 group-hover:scale-100 bg-white p-1.5 size-7 rounded cursor-pointer text-red-400 hover:text-red-700  text-xl transition-all"
                        ...
                        <div className="flex flex-col justify-center items-center h-[80vh]">
                            ...
                            <button
                                className="flex items-center px-5 py-2 mt-5 rounded-md bg-indigo-500 hover:bg-indigo-600 active:scale-95 transition-all "
                                onClick={() => navigate('/')}>
                                <PlusIcon size={18} />
                                Create New
                            </button>
